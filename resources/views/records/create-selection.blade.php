    ...
    <div class="container mx-auto px-4 py-12">
        ...
        <div class="mt-10 text-center">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <a href="{{ route('tracer-responses.index') }}?type=jhs" class="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors duration-300 flex items-center">
                    <i class="fas fa-search mr-2"></i> JHS Alumni Tracker
                </a>
                <a href="{{ route('tracer-responses.index') }}?type=shs" class="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors duration-300 flex items-center">
                    <i class="fas fa-search mr-2"></i> SHS Alumni Tracker
                </a>
