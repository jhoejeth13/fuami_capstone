...
<body>
    ...
    <div class="intro-section animate-fade">
        <div class="animate-fade delay-100">
            <h1>FUAMI Junior High School Graduates Tracker</h1>
            <p>
                The Fr. Urios Academy Of Magallanes, Inc. Junior High School Graduates Tracker is an essential tool for monitoring the careers and further studies of FUAMI's JHS alumni. This system helps FUAMI understand the pathways our JHS graduates take after completing their basic education, whether continuing to senior high school or pursuing other opportunities.
            </p>
            <button class="btn btn-primary" onclick="openForm()">
                <i class="fas fa-edit mr-2"></i> Fill Out JHS Tracer Form
            </button>
        </div>
    </div>
