...
.announcement-image-preview.has-image {
    display: block;
}
    .announcement-current-image {
        margin-top: 1rem;
        font-size: 0.875rem;
        color: #6b7280;
    }
...
<div class="announcement-create-container">
    ...
    <div class="announcement-create-card">
        <div class="p-6">
            <form action="{{ route('announcements.update', $announcement->id) }}" method="POST" id="announcementForm" class="needs-validation" novalidate enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="mb-6">
                    ...
                    <div class="flex justify-between mt-1">
                        ...
                        <small class="text-gray-500"><span id="titleCounter">{{ strlen(old('title', $announcement->title)) }}</span>/100</small>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea class="announcement-form-control announcement-textarea @error('content') is-invalid @enderror" 
                              ...
                              rows="8" 
                              required 
                              placeholder="Provide all relevant details for this announcement">{{ old('content', $announcement->content) }}</textarea>
                ...
                <div class="mb-6">
                    ...
                    <div class="announcement-current-image">
                        <p>Current Image:</p>
                        <img src="{{ asset('storage/' . $announcement->image_path) }}" 
                             alt="Current announcement image" 
                             class="announcement-image-preview"
                             style="max-height: 200px;">
                        <div class="mt-2">
                            <label class="inline-flex items-center">
                                <input type="checkbox" name="remove_image" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                    ...
                    <div class="announcement-input-group mt-3">
                        <span class="announcement-input-group-text">
